...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Piggy Intercity Wiki',
    description: 'Copyright and intellectual property information for Piggy Intercity Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Piggy Intercity Wiki',
      description: 'Copyright and intellectual property information for Piggy Intercity Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Piggy Intercity Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Piggy Intercity Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Piggy Intercity Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Piggy Intercity Developers</strong> - Creators of the Piggy Intercity game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Piggy Intercity</strong> - Trademark of the game developers</li>
              <li><strong>Piggy Intercity Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Piggy Intercity Wiki.
            </p>
            ...
            <p>
              ...
              Piggy Intercity Wiki<br />
              Email: <a href="mailto:dmca@piggy-intercity.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@piggy-intercity.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Piggy Intercity Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Piggy Intercity Wiki (piggy-intercity.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@piggy-intercity.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@piggy-intercity.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@piggy-intercity.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@piggy-intercity.wiki</a>
            </p>
            <p>
